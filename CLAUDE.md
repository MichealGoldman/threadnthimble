...
- `videos.html` — hub page listing links to the individual topic pages (`practical-hand-sewing.html`, `visible-mending.html`, `cross-stitch.html`, `embroidery.html`, `sashiko.html`) as a `.link-list` (vertical list of `.button`-styled links).
